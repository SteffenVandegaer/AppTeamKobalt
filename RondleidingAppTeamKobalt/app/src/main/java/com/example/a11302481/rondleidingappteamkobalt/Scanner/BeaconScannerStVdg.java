...
public class BeaconScannerStVdg {
    ...
    public BeaconScannerStVdg(BluetoothAdapter adapter) {
    ...
    public BeaconScannerStVdg(BluetoothAdapter adapter, int majorToFind, int maxDistance) {
        // create instances of fields
        foundBeacons=new ArrayList<>();
        this.adapter = adapter;
    ...
    public BeaconScannerStVdg(BluetoothAdapter adapter, int majorToFind) {
        // create instances of fields
        foundBeacons=new ArrayList<>();
        this.adapter = adapter;
        this.majorToFind=majorToFind;
